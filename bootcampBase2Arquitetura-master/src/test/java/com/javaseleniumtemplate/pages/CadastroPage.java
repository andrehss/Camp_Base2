...
public class CadastroPage extends PageBase {
    ...
    //Actions
    public void clicarReportIssueField(){
        click(reportIssueField);
    }
    ...
    public void comboBoxSelectProfileId(String profile_id) {
        comboBoxSelectByVisibleText(profileIdComboBox,profile_id);
    }

    public void comboBoxSelectHandlerId(String handler_id) {
        comboBoxSelectByVisibleText(handlerIdComboBox,handler_id);
    }

    public void preencherSummaryField(String summary){
        sendKeys(summaryField,summary);
    }

    public void preencherDescriptionField(String description){
        sendKeys(descriptionField,description);
    }

    public void clicarSubmitReportField(){
        click(submitReportField);
    }
